      ...
      <ul className="grid-list">
        ...
        <li>
          <div className="course-card">
            <figure className="card-banner">
              <img
                src="https://res.cloudinary.com/dctlzmkwh/image/upload/v1696098735/Weave_Images/course-4_pheujm.jpg"
                width={370}
                height={270}
                loading="lazy"
            ...
            <div className="card-content">
              <ul className="card-meta-list">
                <li className="card-meta-item">
                  <ion-icon name="reader-outline" aria-hidden="true" />
                  <span className="card-meta-text">31 Lessons</span>
                </li>
                <li className="card-meta-item">
                  <ion-icon name="time-outline" aria-hidden="true" />
                  <time dateTime="PT18H15M44S" className="card-meta-text">
              ...
              <div className="card-footer">
                <div className="card-price">
                  <span className="span">$49.00</span>
                  <del className="del">$59.00</del>
                </div>
                <div className="card-meta-item">
                  <ion-icon name="people-outline" aria-hidden="true" />
                  <span className="card-meta-text">46 Students</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <li>
          <div className="course-card">
            <figure className="card-banner">
              <img
                src="https://res.cloudinary.com/dctlzmkwh/image/upload/v1696098736/Weave_Images/course-5_svekcj.jpg"
                width={370}
                height={270}
                loading="lazy"
            ...
            <div className="card-content">
              <ul className="card-meta-list">
                <li className="card-meta-item">
                  <ion-icon name="reader-outline" aria-hidden="true" />
                  <span className="card-meta-text">36 Lessons</span>
                </li>
                <li className="card-meta-item">
                  <ion-icon name="time-outline" aria-hidden="true" />
                  <time dateTime="PT18H15M44S" className="card-meta-text">
              ...
              <div className="card-footer">
                ...
                <div className="card-meta-item">
                  <ion-icon name="people-outline" aria-hidden="true" />
                  <span className="card-meta-text">91 Students</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <li>
          <div className="course-card">
            <figure className="card-banner">
              <img
                src="https://res.cloudinary.com/dctlzmkwh/image/upload/v1696098735/Weave_Images/course-6_s2em55.jpg"
                width={370}
                height={270}
                loading="lazy"
            ...
            <div className="card-content">
              <ul className="card-meta-list">
                <li className="card-meta-item">
                  <ion-icon name="reader-outline" aria-hidden="true" />
                  <span className="card-meta-text">21 Lessons</span>
                </li>
                <li className="card-meta-item">
                  <ion-icon name="time-outline" aria-hidden="true" />
                  <time dateTime="PT18H15M44S" className="card-meta-text">
              ...
              <div className="card-footer">
                <div className="card-price">
                  <span className="span">$79.00</span>
                  <del className="del">$89.00</del>
                </div>
                <div className="card-meta-item">
                  <ion-icon name="people-outline" aria-hidden="true" />
                  <span className="card-meta-text">22 Students</span>
                </div>
              </div>
            </div>
          </div>
